...
object *initiate_objects(void)
{
    ...
    srand(time(NULL));
    while () {
        objects->pos_sofa = {(rand() % 1920), -100};
        objects->pos_tv = {(rand() % 1920), -100};
        objects->pos_lamp = {(rand() % 1920), -100};
        objects->pos_photo = {(rand() % 1920), -100};
        objects->pos_trophee = {(rand() % 1920), -100};
        objects->pos_tazer = {(rand() % 1920), -100};
        objects->pos_pan = {(rand() % 19020), -100};
        objects->pos_skate = {(rand() % 1920), -100};
    }
    return (objects);
}

void spawn_objects(sfRenderWindow *home, sfEvent event, texture *textures,  platform *platforms)
{
    ...
    sfSprite_setTexture(sprite1, textures->sofa, sfTrue);
    sfSprite_setPosition(sprite1, objects->pos_sofa);
    sfRenderWindow_drawSprite(home, sprite1, NULL);
    //TV
    ...
    sfSprite_setTexture(sprite2, textures->tv, sfTrue);
    ...
    //Tazer
    if ((objects->pos_tazer.y + 90 <= elem->y &&
         objects->pos_tazer.y + 92 >= elem->y) &&
        (objects->pos_tazer.x  + 60 >= elem->x &&
         objects->pos_tazer.x + 30 <= elem->x_end)){
        objects->pos_tazer.y = elem->y - 90;
        pos_tazer += 5;
    }
    sfSprite_setTexture(sprite6, textures->tazer, sfTrue);
    sfSprite_setPosition(sprite6, objects->pos_pan);
    sfRenderWindow_drawSprite(window, sprite6, NULL);
    //Pan
    if ((objects->pos_pan.y + 90 <= elem->y &&
         objects->pos_pan.y + 92 >= elem->y) &&
        (objects->pos_pan.x  + 60 >= elem->x &&
         objects->pos_pan.x + 30 <= elem->x_end)){
        objects->pos_pan.y = elem->y - 90;
        pos_pan += 5;
    }
    sfSprite_setTexture(sprite7, textures->pan, sfTrue);
    sfSprite_setPosition(sprite7, objects->pos_pan);
    sfRenderWindow_drawSprite(window, sprite7, NULL);
    //Skate
    if ((objects->pos_skate.y + 90 <= elem->y &&
         objects->pos_skate.y + 92 >= elem->y) &&
        (objects->pos_skate.x  + 60 >= elem->x &&
         objects->pos_skate.x + 30 <= elem->x_end)){
        objects->pos_skate.y = elem->y - 90;
        pos_skate += 5;
    }
    sfSprite_setTexture(sprite8, textures->skate, sfTrue);
    sfSprite_setPosition(sprite8, objects->pos_skate);
